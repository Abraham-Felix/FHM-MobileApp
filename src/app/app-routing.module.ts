...
const routes: Routes = [
  ...
  { path: 'executives', loadChildren: './executives/executives.module#ExecutivesPageModule' },
  { path: 'articlespage', loadChildren: './articlespage/articlespage.module#ArticlespagePageModule' },
